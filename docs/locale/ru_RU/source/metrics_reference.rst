...
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| gossip_privdata_commit_block_duration               | histogram | Время, требующееся для сохранения приватных данных и                                   | channel          |  |
|                                                     |           | соответствующего блока (в секундах).                                                   |                  |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| gossip_privdata_fetch_duration                      | histogram | Время, требующееся для извлечения (fetch) отсутствующих приватных данных из пиров (в секундах) | channel          |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| gossip_privdata_list_missing_duration               | histogram | Время, требующееся для перечисления отсутствующих приватных данных (в секундах)                                     | channel          |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| gossip_privdata_pull_duration                       | histogram | Время, требующееся для извлечения (pull) отсутствующего элемента приватных данных (в секундах)                               | channel          |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| gossip_privdata_purge_duration                      | histogram | Время, требующееся для чистки приватных данных (в секундах)                                       | channel          |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| gossip_privdata_reconciliation_duration             | histogram | Время, требующееся для for выполнения согласования (reconciliation) приватных данных (в секундах)                              | channel          |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| gossip_privdata_retrieve_duration                   | histogram | Время, требующееся для извлечения (retrieve) отсутствующих элементов приватных данных                                | channel          |  |
|                                                     |           | из реестра (в секундах)                                                           |                  |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| gossip_privdata_send_duration                       | histogram | Время, требующееся для отправки отсутствующего элемента приватных данных (в секундах)                               | channel          |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
...
| ledger_blockchain_height                            | gauge     | Высота блокчейна в блоках.                                                         | channel          |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| ledger_blockstorage_and_pvtdata_commit_time         | histogram | Время для сохранения приватных данных и данных блока                             | channel          |  |
|                                                     |           | в хранилище (в секундах).                                                                       |                  |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
| ledger_blockstorage_commit_time                     | histogram | Время, нужное для сохранения блока в хранилище в секундах.                             | channel          |  |
+-----------------------------------------------------+-----------+----------------------------------------------------------------------------------------+------------------+--+
...
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| gossip.privdata.commit_block_duration.%{channel}                                        | histogram | Время, требующееся для сохранения приватных данных и                                              |
|                                                                                         |           | соответствующего блока (в секундах)                                                               |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| gossip.privdata.fetch_duration.%{channel}                                               | histogram | Время, требующееся для извлечения (fetch) отсутствующих приватных данных из пиров (в секундах)    |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| gossip.privdata.list_missing_duration.%{channel}                                        | histogram | Время, требующееся для перечисления отсутствующих приватных данных (в секундах)                   |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| gossip.privdata.pull_duration.%{channel}                                                | histogram | Время, требующееся для извлечения (pull) отсутствующего элемента приватных данных (в секундах)    |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| gossip.privdata.purge_duration.%{channel}                                               | histogram | Время, требующееся для чистки приватных данных (в секундах)                                       |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| gossip.privdata.reconciliation_duration.%{channel}                                      | histogram | Время, требующееся для for выполнения согласования (reconciliation) приватных данных (в секундах) |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| gossip.privdata.retrieve_duration.%{channel}                                            | histogram | Время, требующееся для извлечения (retrieve) отсутствующих элементов приватных данных             |
|                                                                                         |           | из реестра (в секундах)                                                                           |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| gossip.privdata.send_duration.%{channel}                                                | histogram | Время, требующееся для отправки отсутствующего элемента приватных данных (в секундах)             |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
...
| ledger.blockchain_height.%{channel}                                                     | gauge     | Высота блокчейна в блоках.                                                                        |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| ledger.blockstorage_and_pvtdata_commit_time.%{channel}                                  | histogram | Время для сохранения приватных данных и данных блока                                              |
|                                                                                         |           | в хранилище (в секундах).                                                                         |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
| ledger.blockstorage_commit_time.%{channel}                                              | histogram | Время, нужное для сохранения блока в хранилище в секундах.                                        |
+-----------------------------------------------------------------------------------------+-----------+---------------------------------------------------------------------------------------------------+
